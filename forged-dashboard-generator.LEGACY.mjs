/**
 * ⚠️ DEPRECATED — QUARANTINED, DO NOT USE OR IMPORT ⚠️
 *
 * This file is the stale, divergent copy of the dashboard generator
 * referenced in the "lib vs top-level generator" review this session.
 * It renders the original flat-card, Day-21-language template — it has
 * NOT received any of the ring/radar/capstone/12-month-membership
 * redesign work applied to netlify/functions/forged-dashboard-
 * generator.mjs.
 *
 * As of this revision, nothing imports this file. Its only caller,
 * forged-daily-nudge.mjs, has had the Day-21 completion block that
 * called it removed entirely (see the QUARANTINE NOTICE at the top of
 * that file).
 *
 * Kept here, renamed with this banner, purely for reference/rollback —
 * NOT deployed as netlify/functions/lib/forged-dashboard-generator.mjs.
 * Delete this file once the full 12-month migration (auto-generation
 * triggered by Monthly Reassessment completion, via the current
 * top-level generator) is built and confirmed working.
 * ─────────────────────────────────────────────────────────────────────
 */
